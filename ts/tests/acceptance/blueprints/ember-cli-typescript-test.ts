...
import * as helpers from 'ember-cli-blueprint-test-helpers/helpers';
import Blueprint from 'ember-cli/lib/models/blueprint';
import Project from 'ember-cli/lib/models/project';

import ects from '../../../blueprints/ember-cli-typescript';
      ...
      if (taskName === 'npm-install') {
        ...
        return {
          run: function(options: any) {
            ...
            options.packages.forEach(function(pkg: any) {
